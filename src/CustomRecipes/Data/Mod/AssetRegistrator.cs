...
public class AssetRegistrator : IModData {
    ...
    public void RegisterData(ProtoRegistrator registrator) {
		...
		DirectoryInfo modules = new DirectoryInfo($"{BASE_PATH}/Definitions");
	...
	private static Dictionary<string, object> resolvers(ProtoRegistrator registrator) {
		Dictionary<string, object> context = new Dictionary<string, object> {
			...
			["add_texture"] = new Constructor(["path", "replace"], (args) => {
				...
				byte[] image = File.ReadAllBytes(Path.Combine(BASE_PATH, assetPath));
