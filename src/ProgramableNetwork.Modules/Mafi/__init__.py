...
class EventNonSaveable:
    ...
    def __init__(self):
        self.RegisteredEventsCount = int(0)
...
class Fix32:
    ...
    def __init__(self):
        ...
        self.IntegerPart = int(0)
        self.IntegerPartNonNegative = int(0)
...
class Vector2i:
    ...
    def __init__(self):
        self.Sum = int(0)
        self.Product = None
        self.ProductInt = int(0)
        from Mafi import Fix32
        self.Length = Fix32()
        self.LengthInt = int(0)
        self.LengthSqrInt = int(0)
        self.LengthSqr = None
        self.IsZero = False
        self.IsNotZero = False
        self.IncrementX = None
...
class StringFormatMethodAttribute:
    ...
    def __init__(self):
        self.FormatParameterName = str(0)
        self.TypeId = None
...
class LanguageInjectionAttribute:
    ...
    def __init__(self):
        ...
        self.InjectedLanguageName = str(0)
        self.Prefix = str(0)
        self.Suffix = str(0)
        self.TypeId = None
...
class CodeTemplateAttribute:
    ...
    def __init__(self):
        self.SearchTemplate = str(0)
        self.Message = str(0)
        self.ReplaceTemplate = str(0)
        self.ReplaceMessage = str(0)
        self.FormatAfterReplace = False
        self.MatchSimilarConstructs = False
        self.ShortenReferences = False
        self.SuppressionKey = str(0)
        self.TypeId = None
...
class AspMinimalApiImplicitEndpointDeclarationAttribute:
    ...
    def __init__(self):
        self.HttpVerb = str(0)
        self.RouteTemplate = str(0)
        self.BodyType = None
        self.QueryParameters = str(0)
        self.TypeId = None
...
class RazorInjectionAttribute:
    ...
    def __init__(self):
        self.Type = str(0)
        self.FieldName = str(0)
        self.TypeId = None
class RazorDirectiveAttribute:

    def __init__(self):
        self.Directive = str(0)
        self.TypeId = None
...
class RelGameDate:
    ...
    def __init__(self):
        ...
        self.IsNotNegative = False
        self.Squared = None
        self.TotalDays = int(0)
        self.TotalMonthsFloored = int(0)
        self.TotalMonthsRounded = int(0)
        self.Days = int(0)
        self.Months = int(0)
        self.Years = int(0)
class RelTile1f:
...
class DebugGameRendererConfig:
    SaveVehiclePathFindingSuccesses = None
    SaveVehiclePathFindingFailures = None
    SaveVehiclePathFindingFailuresClosebyApproach = None
    SaveVehicleIdleTooLong = None
    SaveVehicleGettingUnstuck = None
    SaveVehicleReachabilityResults = None
    SaveVehicleHomeUnreachable = None
    SaveVehicleFailToReachHome = None
    SaveVehicleGoalUnreachable = None
    SaveVehicleGoalReplanDueToBlock = None
    SaveVehicleDriveTooFarWithoutPf = None
    SaveTrainPathFindingGraph = None
    SaveTrainPathFindingAttempts = None
    SaveTransportPillarsSupportFailures = None
    SaveClearancePathabilityProviderValidationErrors = None
    SaveSuspiciouslyLongVehicleDriveTargets = None
    SaveLayoutEntityFailedToBuild = None
